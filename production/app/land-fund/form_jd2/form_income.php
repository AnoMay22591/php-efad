                        ...
                        <div class="col-lg-12">
                            <div class="row" id="wellpages" style="display: none;">
                                <div class="col-md-12 col-sm-12 col-lg-12">
                                    <div class="x_panel">
                                        <div class="x_title">
                                            <h2>บันทึกรายรับ สำหรับแบบ จด.02</h2>
                                ...
                                <div class="col-md-12 col-sm-12 col-lg-12">
                                    <div class="x_panel">
                                        <div class="x_title">
                                            <h2>แจกแจงงบประมาณ สำหรับแบบ จด.02</h2>
                                            <div class="clearfix"></div>
                                        </div>
                                        <div class="x_content" >
                                            <div class="row">
                    ...
                    '<div class="col-lg-12" id="box'+rowbox+'">'+
                        '<div class="col-lg-6">'+
                            ...
                            '<select class="form-control" id="typemoney" name="typemoney[]">'+
                                ...
                                '<option value="ค่าจ้างลูกจ้างชั่วคราว" >ค่าจ้างลูกจ้างชั่วคราว</option>'+
                                '<option value="เงินค่าประกันสังคมส่วนของนายจ้าง" >เงินค่าประกันสังคมส่วนของนายจ้าง</option>'+
                                '<option value="ค่าจ้างชั่วคราวรายเดือน" >ค่าจ้างชั่วคราวรายเดือน</option>'+
                                '<option value="ค่าตอบแทนใช้สอยวัสดุและสาธารณูปโภค" >ค่าตอบแทนใช้สอยวัสดุและสาธารณูปโภค</option>'+
