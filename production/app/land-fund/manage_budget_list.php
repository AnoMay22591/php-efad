                        ...
                        <div class="col-lg-12">
                            <div class="row" id="wellpages" style="display: none;">
                                <div class="col-md-12 col-sm-12 col-lg-12">
                                    <div class="x_panel">
                                        <div class="x_title">
                                            <h2>รายการคำขอการเบิกจ่ายงบประมาณ</h2>
                                                    ...
                                                    <table table id="tableAlert2" width="100%" class="table table-striped table-bordered table-hover" cellpadding="0" cellspacing="0"  border="0" width="100%">
                                                        <thead>
                                                            <tr role="row">
                                                                ...
                                                                <th class="sorting" tabindex="0" style="width: 10%;">จัดการ</th>
                                                            </tr>
                                                        </thead>
                                                        <tbody>
                                                        <tr role="row" class="odd">
                                                                ...
                                                                <td >เงินงบประมาณ</td> 
                                                                <td align="center"><button type="button" class="btn btn-success" onclick="goto()"><i class="fa fa-share-alt"></i> จัดการงบ</button></td> 
                                                            </tr>
                                                            <tr role="row" class="odd">
...
function goto(){
    window.open("../ManageBudgetDetail/");
}
</script>
