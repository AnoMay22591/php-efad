                            ...
                            <div class="row" id="wellpages" style="display: none;">
                                <div class="col-md-12 col-sm-12 col-lg-12" style="margin-bottom: 15px;">
                                    <div class="col-md-12 col-sm-12  ">
                                        <div class="x_panel">
                                            <div class="x_title">
                                                <h2><i class="fa fa-bars"></i> รายการขอเบิก <small>รายการต่างๆในแบบ จด.02</small></h2>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-12 col-sm-12 col-lg-12" style="margin-bottom: 15px;">
                                                                <div class="col-lg-3">
                                                                    ...
                                                                    <input class="form-control" value="3000000" disabled>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-md-12 col-sm-12 col-lg-12" style="margin-bottom: 15px;"><hr />
                                                                <div class="col-lg-12">
                                                                    <h3>ยอดยกมา งบเบิกจ่าย</h3>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-12 col-sm-12 col-lg-12" style="margin-bottom: 15px;">
                                                                <div class="col-lg-3">
                                                                    <label>ค่าครุภัณฑ์</label>
                                                                    <input class="form-control" value="0" disabled>
                                                                </div>
                                                                <div class="col-lg-3">
                                                                    <label>ค่าลูกจ้างชั่วคราว</label>
                                                                    <input class="form-control" value="0" disabled>
                                                                </div>
                                                                <div class="col-lg-3">
